...
template <typename specificmodel>
void researcher<specificmodel>::PP0xy_x0_y0_alpha_epsilon_dt_fp_ap_t0_t1 (double x0, double y0, double alpha, double epsilon, double dt, double fp, double ap, long t0, long t1) {
    specificmodel model;
    model.set_par_a(alpha);
    model.set_par_e(epsilon);
    model.set_buffer_size(2);
