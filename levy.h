...
void levy::set_pars (int set_size, double set_par_mu, double set_par_alpha, double set_par_beta, double set_par_sigma, long set_idum) {
    if (set_size>0) {
        val.resize(set_size);
    }
    else {
...
void levy::change_beta (double set_par_beta) {
    if ( (set_par_beta>(-1.0-1.0e-10)) && (set_par_beta<(1.0+1.0e-10)) ) {
        par_beta = set_par_beta;
    }
    else {
...
void levy::change_alpha (double set_par_alpha) {
    if ( (set_par_alpha>.0)&&(set_par_alpha<(2.0+1.0e-10)) ) {
        par_alpha = set_par_alpha;
    }
    else {
