...
std::string trimodal::get_basename () {
...
void trimodal::set_pars1 (int set_size, double set_par_mu, double set_par_alpha, double set_par_beta, double set_par_sigma, long set_idum) {
...
void trimodal::set_pars2 (int set_size, double set_par_mu, double set_par_alpha, double set_par_beta, double set_par_sigma, long set_idum) {
...
void trimodal::set_pars3 (int set_size, double set_par_mu, double set_par_alpha, double set_par_beta, double set_par_sigma, long set_idum) {
